...
@section('body')
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('admin.craftsman.product.bids', $product->id) }}" method="GET">
                                ...
                                <div class="form-action col-sm-12 text-right">
                                    ...
                                    <a class="btn btn-default"
                                        href="{{ route('admin.craftsman.product.bids', $product->id) }}">{{ __('Cancel') }}
                                    </a>
                                </div>
                            </form>
                        </div>
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-book"></i>{{ __('Bids') }}: {{ $product->title }}</h3>
                </div>
                <div class="panel-body">
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        <thead class="flip-content">
                            <tr>
                                ...
                                <th class="text-center">{{ __('Buyer Details') }}</th>
                            ...
                            @foreach ($bids as $bid)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.buyers.show', $bid->user->id) }}">
                                            {{ $bid->user->username}}
                                        </a>
                                    </td>
                                    <td class="text-center">
    ...
    <div class="text-center ">
        <a href="{{ route('admin.craftsman.product', $product->id) }}" type="reset" name="cancel"
