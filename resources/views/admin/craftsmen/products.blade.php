                        ...
                        <div class="col-md-12">
                            <form action="{{route('admin.craftsman.products', $craftsman->id)}}" method="GET">
                                <div class="form-group lg-10">
                                    <input type="text" name="name" placeholder="{{__('search by product title, Price or description')}}" class="form-control"
                        ...
                        @foreach($products as $product)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('admin.craftsman.product', $product->id)}}" class="btn btn-primary ">
