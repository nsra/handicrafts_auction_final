...
<head>
    ...
    <style>
        .avocode{
            display:flex; align-items:center; justifycontent:center; padding:auto
        }
        .borderd {
              border: solid black;
        }
                    ...
                    <div class="col-md-10">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h1 class="panel-title" style="font-size: 28px">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; {{__('Quick Statistic    -    Handicrafts Auction ')}}<i class="fa fa-gavel"></i></h1>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-action md-2 ">
                                            <div class="col-xs-6 text-center">
                                                <a class="btn btn-default" href="{{route('categories.index')}}">Ctegories: {{$categories}}</a>
                                            </div>
                                            <div class="col-xs-6  text-left">
                                                <a class="btn btn-default" href="{{route('buyers.index')}}">Buyers: {{$buyers}}</a>
                                            </div>
                                        </div>
                                        <br>
                                        <br>
                                        ...
                                        <div class="form-action md-2">
                                            <div class="col-xs-10 text-center">
                                                <a class="btn btn-default" href="{{route('craftsmen.index')}}">Craftsmen: {{$craftsmen}}</a>
                                            </div>
                                            <br>
                                            <br>
                                            <hr>
