      ...
      <div class="content-confirmeOrder">
        ...
        <div class="row">
          ...
          <div class="col-9 description-product">
            ...
            <span>
              CraftsmanInfo : <a href="{{route('product.craftsman', $product->id)}}" >{{$product->user->username}} </a> 
        ...
        <div class="text-center">
            <br>
            <button class="btn btn-warning btn-lg" style="background-color: #ffbb00; color:black;" onclick="window.location='{{route('index') }}'" >
        ...
        <div class="row">
            <div class="col-2">
               <h6 class="ml-5" style="margin-left: 0; padding-left: 0">{{auth()->user()->username}}</h6>
            </div>
            ...
            <div class="col-4">
                <br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
               <a class="btn btn-lg " target="_blank" href="{{route('buyer_profile.edit') }}" style="background-color: #ffbb00; color:black"><i class="fas fa-pen"></i> Update Your Information</a>
            </div>
            
          </div>
          <br>
          <form action="{{route('buyer.store_order_now', $product->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
