        ...
        <div class="container MyProfile-container p-3">
            ...
            <div class="text-center">
                <a data-toggle="modal" class="btn btn-warning smallButton" data-target="#smallModal"
                    data-attr="{{ route('buyer.edit_image', $user->id) }}" title="{{ __('Update Your Image')}}">
                ...
                <div class="row col-10">
                    ...
                    <div class="col-3">
                        &nbsp;&nbsp; <a class="btn btn-lg btn-secondary" href="{{ route('buyer.ordered_products') }}"
                            style="color:black"> &nbsp; &nbsp; &nbsp; &nbsp;{{ __('My Orders')}} &nbsp; &nbsp; &nbsp;</a>
                    </div>
                <div>
                    <br>
                    <form action="{{ route('buyer_profile.update', $user->id) }}" method="POST"
                        ...
                        <div class="input-form text-center">
                            ...
                            &nbsp; &nbsp; &nbsp; &nbsp;
                            <a class="btn btn-lg " href="{{ route('buyer_password.change', $user->id) }}"
