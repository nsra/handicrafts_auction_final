      ...
      <div class="row mb-4">
        <div class="col">
            <div class="input-form float-end">
                <a class="btn btn-lg btn-secondary" href="{{route('buyer.bids')}}" style="color:black"> &nbsp;  &nbsp; View My Bids &nbsp; &nbsp;  &nbsp; </a>
            </div>
        </div>
        <div class="col mb-4">
            <div class="input-form">
                &nbsp;&nbsp; <a class="btn btn-lg btn-secondary" href="{{route('buyer.ordered_products')}}" style="color:black"> &nbsp; &nbsp; &nbsp; &nbsp;My Orders  &nbsp; &nbsp; &nbsp;</a>
            </div>
        </div>
    <div>
        <br>
