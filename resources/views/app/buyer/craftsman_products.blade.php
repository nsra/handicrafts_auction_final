...
@section('content')
 ...
 <div class="MyProduct">
    <div class="container container-myProduct">
      ...
      <div class="my-product-content">
        ...
        <div class="row ">
          ...
          <div class="col-1">
            <h4><a href="{{route('buyer.product.bids', $product->id)}}">{{$product->bids->count()}}Bids</a></h4>
          </div>
        </div>
        @endforeach
      </div>
    ...
    <div class="input-form text-center">
      <a class="btn btn-lg " href="{{route('buyer.product.craftsman', $user->id)}}" style="background-color: #ffbb00; color:black">Cancel</a>
    </div>
    <br>
    <br>
    <br>
