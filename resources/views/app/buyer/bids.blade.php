    ...
    <div class="container container-mybid">
      ...
      <div class="form group mt-4 mb-3">
        <form action="{{route('buyer.bids')}}" method="GET">
          <input name="name" size="40"  value="{{app('request')->get('name')}}" class="" type="search" placeholder="Search for bid by price">
      ...
      <div class="my-bid-content">
        ...
        <div class="row ">
          ...
          <div class="col-3">
            <h4>
              <a href="{{route('buyer.product.craftsman', $bid->product->user->id)}}">{{$bid->product->user->username}}</a>
            </h4>
          </div>
          ...
          @else
          <div class="col-1">
            <a data-toggle="modal" class="btn btn-lg" id="smallButton" data-target="#smallModal" data-attr="{{ route('buyer.bid.delete', $bid->id) }}" title="Delete Bid">
