...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="form-action">
                            ...
                            <button class="btn btn-success">You Win This Product Auction</button>
                            @elseif($product->authUserBidId() > 0)
                            <div class="form-group">
                               
                                <a data-toggle="modal" class="btn btn-lg" id="smallButton" data-target="#smallModal" data-attr="{{ route('buyer.bid.delete', $product->authUserBidId()) }}" title="Delete Bid">
    ...
    <div class="text-center ">
        <a href="{{route('buyer.profile')}}" type="reset" name="cancel"
