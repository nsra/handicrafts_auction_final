                    ...
                    <div class="row">
                                ...
                                <div class="form-group ">
                                    ...
                                    <br>
                                        <div class="form-group">
                                                ...
                                                <a data-toggle="modal" class="btn btn-lg" id="smallButton" data-target="#smallModal" data-attr="{{ route('craftsman.product.delete', $product->id) }}" title="Delete Product">
                        ...
                        <div class="col-4 text-center">
                            <form action="{{route('craftsman.product.extend_auction', $product->id)}}" method="GET">
                                ...
                                <input type="number" max="15" min="1" placeholder="Enter number of days to extend auction" name="days" style="width:92%">
                                <br>
                                <br>
                                <button type="submit" 
                                    class="btn btn-secondary">{{__('extend auction')}}</button>
                            </form>
                        </div>
                    </div>
                </div>
