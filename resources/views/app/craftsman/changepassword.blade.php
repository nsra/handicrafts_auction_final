  ...
  <div class="MyProfile">
    ...
    <div class="col-md-11 container MyProfile-container p-3">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('craftsman_password.update', $user->id)}}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-action text-center">
                        <button type="submit" href="{{route('craftsman_password.change')}}"
                            class="btn btn-warning">{{__('Change password')}}</button>

                        <a href="{{route('craftsman_profile.edit')}}" type="reset"
