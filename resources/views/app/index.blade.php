...
<div class="sec-nav shadow-sm p-1">
  ...
  <div class="alert alert-warning alert-dismissible fade show" role="alert">
    <strong>{{$authUserOrderedProducts}} Of Your Products has been ordered! </strong> Please Check Your Ordered Products Panel, You have to deliver ordered products to your buyers within 3 hours.
