      ...
      <br>
        <div class="category mt-3">
          ...
          <div class="row">
            <div class="col-3">
              <div class="card" style="margin-bottom: 5%!important">
                <img src="{{asset('/HandicraftsAuction/image/painting.jfif')}}" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col-3">
              <div class="card">
                <img src="{{asset('/HandicraftsAuction/image/paper.jfif')}}" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col-3">
              <div class="card ">
                <img src="{{asset('/HandicraftsAuction/image/embroideries.jfif')}}" class="card-img-top" alt="...">
                <div class="card-body">
          ...
          <div class="row">
            <div class="col-3">
              <div class="card">
                <img src="{{asset('/HandicraftsAuction/image/wood.jfif')}}" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col-3">
              <div class="card">
                <img src="{{asset('/HandicraftsAuction/image/beads.jfif')}}" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col-3">
              <div class="card ">
                <img src="{{asset('/HandicraftsAuction/image/natural.jfif')}}" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col-3">
              <div class="card">
                <img src="{{asset('/HandicraftsAuction/image/Leather.jfif')}}" class="card-img-top" alt="...">
                <div class="card-body">
          ...
          <div class="row">
            <div class="col-3">
              <div class="card">
                <img src="{{asset('/HandicraftsAuction/image/plastic.jfif')}}" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col-3">
              <div class="card">
                <img src="{{asset('/HandicraftsAuction/image/glass.jfif')}}" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col-3">
              <div class="card ">
                <img src="{{asset('/HandicraftsAuction/image/clay.jfif')}}" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col-3">
              <div class="card">
                <img src="{{asset('/HandicraftsAuction/image/metals.jfif')}}" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="use mt-4">
          ...
          <div class="card mb-3" style="max-width: 1000px;">
            <div class="row g-0">
              <div class="col-md-4">
                <img src="{{asset('/HandicraftsAuction/image/craftsman.PNG')}}" class="img-fluid rounded-start" style=" display: block;
                margin-left: auto;
                margin-right: auto;
                width: 50%;" alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <p class="card-text">By registering as a crafttsman you can add your handmade product for sale (ordered) by auction,
                    or by a high OrderNow Price. you can't order a product with craftsman role, create buyer account to bid or order products</p>
          ...
          <div class="card mb-3" style="max-width: 1000px;">
            <div class="row g-0">
              <div class="col-md-4">
                <img src="{{asset('/HandicraftsAuction/image/buyer.PNG')}}" class="img-fluid rounded-start" style=" display: block;
                margin-left: auto;
                margin-right: auto;
                width: 50%;" alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <p class="card-text">By registering as a crafttsman you can order-now and place bidds to order products by action, after you success orderring aproduct you have to confirm its shipping from your orders panel
                   you can't list your own products with buyer role, creat buyer account to list your candmads.</p>
          ...
          <div class="row">
            <div class="col ">
              <div class="card" style="width: 300px; margin-left: 230px;">
                <img src="{{asset('/HandicraftsAuction/image/entesar.jpg')}}" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card" style="width: 300px;">
                <img src="{{asset('/HandicraftsAuction/image/Amany.jfif')}}" class="card-img-top" alt="...">
                <div class="card-body">
